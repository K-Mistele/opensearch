...
export namespace partial_types {
    ...
    export interface OverallState {
        messages?: (partial_types.Message | null)[]
        search_query?: (string | null)[]
        web_research_result?: (string | null)[]
        sources_gathered?: (string | null)[]
        initial_search_query_count?: (number | null)
        max_research_loops?: (number | null)
